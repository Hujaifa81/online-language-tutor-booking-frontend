...
import { IoLogoLinkedin, IoLogoXbox } from "react-icons/io";
            ...
            <footer className="footer sm:footer-horizontal bg-black text-white p-10 ">
                ...
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <a href="https://x.com/m_a_hujaifa" target="_blank">
                        <FaXTwitter size={25}/>
                        </a>
                        ...
                        <a href="https://www.facebook.com/abu.hujaifa.4/" target="_blank">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
